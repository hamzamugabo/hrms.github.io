...
const submitForm = async () => {
    ...
    const url = `${baseURL}/performance_metric/supervisor_behavioral/create/supervisor`;
            ...
            <div class="grid">
                <div class="col-12">
                    <div class="card">
                        ...
                        <h5>Create Supervisor Behavioral Metric</h5>
                        <div class="p-fluid formgrid grid">
                            ...
                            <div class="field col-12 md:col-12">
                                ...
                                <InputText required id="employeeIntegrity" type="text" v-model="employeeIntegrity" />
                            </div>

                            <div class="field col-12 md:col-12">
                                <label for="employeeProfessionalism">Employee Professionalism</label>
                                <InputText required id="employeeProfessionalism" type="text" v-model="employeeProfessionalism" />
                            </div>

                            <div class="field col-12 md:col-12">
                                <label for="employeeQualityOfService">Employee Quality Of Service</label>
                                <InputText required id="employeeQualityOfService" type="text" v-model="employeeQualityOfService" />
                            </div>

                            <div class="field col-12 md:col-12">
                                <label for="employeeRiskManagement">Employee Risk Management</label>
                                <InputText required id="employeeRiskManagement" type="text" v-model="employeeRiskManagement" />
                            </div>

                            <div class="field col-12 md:col-12">
                                <label for="employeeTeamwork">Employee Teamwork</label>
                                <InputText required id="employeeTeamwork" type="text" v-model="employeeTeamwork" />
                            </div>
                        </div>
                    </div>
                </div>
