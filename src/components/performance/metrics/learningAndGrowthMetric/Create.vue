...
const submitForm = async () => {
    ...
    const url = `${baseURL}/performance_metric/learning_and_growth/create`;
            ...
            <div class="grid">
                <div class="col-12">
                    <div class="card">
                        ...
                        <h5>Create Learn And Growth Metric</h5>
                        <div class="p-fluid formgrid grid">
                            ...
                            <div class="field col-12 md:col-12">
                                ...
                                <!-- <InputText required id="employeeSatisfactionScore" type="text" v-model="employeeSatisfactionScore" /> -->
                            </div>
                            ...
                            <div class="field col-12 md:col-12">
                                ...
                                <!-- <InputText required id="totalTrainingHours" type="text" v-model="totalTrainingHours" /> -->
                            </div>
