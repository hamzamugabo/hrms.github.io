...
import Create from '@/components/performance/metrics/SupervisorLearningAndGrowthMetric/Create.vue';
...
const updateMetric = async () => {
    ...
    try {
        loading.value = true;
        const url = `${baseURL}/performance_metric/supervisor_learning_metric/update`;
        const formData = {
...
const handleConfirmDelete = async (data) => {
    const url = `${baseURL}/performance_metric/supervisor_learning_metric/${data?.id}`;
