...
const submitForm = async () => {
    ...
    const url = `${baseURL}/performance_metric/supervisor_financial/create`;
            ...
            <div class="grid">
                <div class="col-12">
                    <div class="card">
                        ...
                        <h5>Create Supervisor Financial Metric</h5>
                        <div class="p-fluid formgrid grid">
                            ...
                            <div class="field col-12 md:col-12">
                                ...
                                <!-- <InputText required id="expenses" type="text" v-model="expenses" /> -->
                            </div>
                            ...
                            <div class="field col-12 md:col-12">
                                ...
                                <!-- <InputText required id="revenue" type="text" v-model="revenue" /> -->
                            </div>
