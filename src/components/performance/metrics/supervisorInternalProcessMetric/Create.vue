...
const submitForm = async () => {
    ...
    const url = `${baseAUTHURL}/performance_metric/supervisor_internal_process`;
            ...
            <div class="grid">
                <div class="col-12">
                    <div class="card">
                        ...
                        <h5>Create Supervisor Internal Process Metric</h5>
                        <div class="p-fluid formgrid grid">
                            ...
                            <div class="field col-12 md:col-12">
                                ...
                                <!-- <InputText required id="errorsDetected" type="text" v-model="errorsDetected" /> -->
                            </div>
                            ...
                            <div class="field col-12 md:col-12">
                                ...
                                <!-- <InputText required id="totalOrdersProcessed" type="text" v-model="totalOrdersProcessed" /> -->
                            </div>
