...
// const submitPayload = () => {
//     const formData = {
//         organizationalObjectiveId: organizationalObjectiveId.value.id,
...
const submitForm = async () => {
    ...
    const url = `${baseURL}/progress_update/create/organizational-objective`;
...
// watch([progressStatus, organizationalObjectiveId], () => {
//     submitPayload();
// });
</script>
<template>
                    ...
                    <div class="card">
                        ...
                        <div class="p-fluid formgrid grid">
                            <div class="field col-12 md:col-12">
                                ...
                                <AutoComplete
                                    placeholder="Search Organisation objective"
                                    id="objective"
                                    :dropdown="true"
                                    :multiple="false"
                                    v-model="organizationalObjectiveId"
