...
const submitForm = async () => {
    ...
    const url = `${baseURL}/progress_update/create/department-objective`;
...
// watch([progressStatus, departmentObjectiveId], () => {
//     submitPayload();
// });
</script>
<template>
                    ...
                    <div class="card">
                        ...
                        <div class="p-fluid formgrid grid">
                            <div class="field col-12 md:col-12">
                                ...
                                <AutoComplete
                                    placeholder="Search Department objective"
                                    id="objective"
                                    :dropdown="true"
                                    :multiple="false"
                                    v-model="departmentObjectiveId"
