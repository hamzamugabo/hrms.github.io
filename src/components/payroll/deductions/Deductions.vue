...
const { getDeductions, getEmployees, searchDdeuctionByEmployeeId, updateDeduction, searchByDateRange } = utils();
...
const clearFilter = () => {
    initFilters();
    getDeductions(deductions, loading);
};
...
const submitForm = async () => {
    ...
    try {
        const payload = { ...deductionDataToUpdate.value };
    ...
    <div class="flex justify-content-center">
        <Dialog v-model:visible="visible" header="Edit Deduction" :style="{ width: '50%' }">
            ...
            <UpdateDeduction
                ...
                :tin="deductionData.tinNumber"
                :nssf="deductionData.nssfNumber"
            />
        ...
        <Dialog v-model:visible="addModalVisibility" header="Add Deduction" :style="{ width: '50%' }">
            <UpdateDeduction @handleDeduction="handleDeduction" />
